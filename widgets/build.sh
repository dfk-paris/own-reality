...
function lib {
  log "compiling lib"
  cat widgets/app.js.coffee widgets/lib/* widgets/locale/* \
    | node_modules/.bin/coffee -s -b -p > public/lib.js
}
...
function app {
  ...
  catnl public/vendor.js public/lib.js public/tags.js > public/app-noboot.js
  catnl public/app-noboot.js widgets/boot.js > public/app.js
}
...
function watch_lib {
  onchange widgets/app.js.coffee widgets/lib widgets/locale \
    -- widgets/build.sh lib
}
